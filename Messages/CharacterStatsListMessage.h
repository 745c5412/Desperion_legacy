...
#ifndef __CHARACTER_STATS_LIST_MESSAGE__
#define __CHARACTER_STATS_LIST_MESSAGE__
...
public:
	...
	CharacterStatsListMessage(CharacterCharacteristicsInformations* stats) : stats(stats)
	{
	}
