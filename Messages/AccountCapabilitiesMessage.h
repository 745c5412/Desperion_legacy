...
public:
	...
	AccountCapabilitiesMessage(int accountId, bool tutorialAvailable, int16 breedsVisible, int16 breedsAvailable) : accountId(accountId), tutorialAvailable(tutorialAvailable), breedsVisible(breedsVisible), breedsAvailable(breedsAvailable)
	{
	}
