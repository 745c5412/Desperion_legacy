...
#ifndef __GAME_ACTION_FIGHT_DISPELLABLE_EFFECT_MESSAGE__
#define __GAME_ACTION_FIGHT_DISPELLABLE_EFFECT_MESSAGE__
...
public:
	...
	{ return SMSG_GAME_ACTION_FIGHT_DISPELLABLE_EFFECT; }

	GameActionFightDispellableEffectMessage()
	{
	}

	GameActionFightDispellableEffectMessage(int16 actionId, int sourceId, AbstractFightDispellableEffect* effect) : AbstractGameActionMessage(actionId, sourceId), effect(effect)
	{
	}
