...
public:
	...
	ChatClientMultiWithObjectMessage(std::string content, int8 channel, std::vector<ObjectItemPtr>& objects) : ChatClientMultiMessage(content, channel), objects(objects)
	{
	}
