...
public:
	...
	ChatAbstractServerMessage(int8 channel, std::string content, int timestamp, std::string fingerprint) : channel(channel), content(content), timestamp(timestamp), fingerprint(fingerprint)
	{
	}
